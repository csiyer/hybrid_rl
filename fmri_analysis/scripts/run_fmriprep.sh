...
singularity run --home $HOME --cleanenv \
    ...
    /burg/dslab/users/csi2108/hybrid_mri_bids /burg/dslab/users/csi2108/hybrid_mri_bids/derivatives/fmriprep \
    participant -w /burg/dslab/users/csi2108/work/ --participant-label $SUBJECT_ID \
    --nthreads 8  --fs-license-file /burg/dslab/users/csi2108/mri_utils/freesurfer_license.txt